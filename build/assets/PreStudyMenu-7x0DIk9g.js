...
- ✅ 文法クイズで学んだ知識の実践
- ✅ ガチャ語彙の効果的活用
- ✅ TOEICライティングセクション対策`,keyPoints:["シンプルな文から複雑な文へ","語彙レベルの戦略的使い分け","文法知識の実践的応用","ガチャ語彙との相乗効果"],examples:[{english:"Having analyzed the data, we decided to implement the new strategy.",japanese:"データを分析した結果、新戦略を実施することを決定しました。",explanation:"分詞構文 + 上級語彙の組み合わせ"},{english:"The comprehensive report, which was written by our team, provides valuable insights.",japanese:"私たちのチームが作成した包括的なレポートは、貴重な洞察を提供します。",explanation:"関係詞 + 上級語彙での複雑な文構造"}],relatedProblems:["writing"],prerequisites:["basic-grammar-theory","tenses-theory","relative-theory","participle-theory"]}];function S(a){return E.filter(l=>l.level<=a)}const y=({content:a,isLocked:l=!1,isCompleted:o=!1,onSelect:s})=>{const i=c=>{switch(c){case"theory":return"💡";case"explanation":return"📚";case"background":return"🔬";case"strategy":return"🎯";default:return"📖"}};return t.jsx(P,{id:a.id,title:a.title,description:`⭐️ ${a.category}`,detail:`理論学習 - ${a.contentType}`,icon:i(a.contentType),difficulty:a.difficulty,level:a.level,duration:`${Math.ceil(a.duration/60)}分`,category:a.category,keyPoints:a.keyPoints,isLocked:l,isCompleted:o,onClick:s})};function z(){const a=T();I();const o=k().getLevel(),s=typeof o=="object"?o.level||1:o||1,i=S(s),c=C.getPreStudyProgress(),r=c.completedContents;console.log("PreStudyMenu - Debug Info:",{userLevel:s,availableContentsCount:i.length,completedContents:r,preStudyProgress:c});const[h,g]=u.useState("all"),[d,b]=u.useState("all"),f=Array.from(new Set(i.map(e=>e.category))),v=Array.from(new Set(i.map(e=>e.level))).sort((e,n)=>e-n),m=u.useMemo(()=>i.filter(e=>{const n=h==="all"||e.category===h,w=d==="all"||e.level.toString()===d,x=e.level<=s;return n&&w&&x}),[i,h,d,s]),p=u.useMemo(()=>m.find(e=>!r.includes(e.id)&&e.level<=s),[m,r,s]);return t.jsx("div",{className:"min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4",children:t.jsxs("div",{className:"max-w-4xl mx-auto",children:[t.jsxs("div",{className:"flex items-center justify-between mb-6",children:[t.jsxs(j,{variant:"outline",onClick:()=>a("/"),className:"flex items-center gap-2",children:[t.jsx(O,{className:"w-4 h-4"}),"戻る"]}),t.jsxs("div",{className:"text-center",children:[t.jsxs("h1",{className:"text-2xl font-bold text-gray-800 flex items-center gap-2 justify-center",children:[t.jsx("span",{children:"📚"}),"事前学習"]}),t.jsx("p",{className:"text-gray-600 mt-2",children:"理論を理解してから実践へ"})]}),t.jsx("div",{className:"w-24"})]}),t.jsxs("div",{className:"flex gap-4 mb-6",children:[t.jsxs("select",{value:h,onChange:e=>g(e.target.value),className:"px-3 py-2 border border-gray-300 rounded-lg bg-white shadow-sm hover:border-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors",children:[t.jsx("option",{value:"all",children:"すべてのカテゴリ"}),f.map(e=>t.jsx("option",{value:e,children:e},e))]}),t.jsxs("select",{value:d,onChange:e=>b(e.target.value),className:"px-3 py-2 border border-gray-300 rounded-lg bg-white shadow-sm hover:border-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors",children:[t.jsx("option",{value:"all",children:"すべてのレベル"}),v.map(e=>t.jsxs("option",{value:e.toString(),children:["Level ",e]},e))]})]}),p&&t.jsxs("div",{className:"mb-8",children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-800 mb-4",children:"🎯 推奨コンテンツ"}),t.jsx(y,{content:p,isCompleted:r.includes(p.id),onSelect:e=>a(`/learning/pre-study/content/${e}`)})]}),t.jsxs("div",{children:[t.jsx("h2",{className:"text-lg font-semibold text-gray-800 mb-4",children:"📖 利用可能なコンテンツ"}),t.jsx("div",{className:"grid gap-4 md:grid-cols-2 lg:grid-cols-3",children:m.map(e=>t.jsx(y,{content:e,isLocked:e.level>s,isCompleted:r.includes(e.id),onSelect:n=>a(`/learning/pre-study/content/${n}`)},e.id))}),m.length===0&&t.jsxs("div",{className:"text-center py-12",children:[t.jsx("div",{className:"text-4xl mb-4",children:"📚"}),t.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-2",children:"該当するコンテンツがありません"}),t.jsx("p",{className:"text-gray-600",children:"フィルターを変更するか、レベルアップして新しいコンテンツを解放しましょう。"})]})]})]})})}export{z as default};
