...
export const essayPrompts: EssayPrompt[] = [
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたの趣味について、なぜそれが好きなのかも含めて4-5文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたにとって理想的な週末の過ごし方について5-6文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "重要な会議の内容と決定事項について、上司への報告として4-5文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "プロジェクトの遅延について顧客に謝罪し、解決策を提示するメールを5-6文で書いてください。",
    ...
    sampleAnswers: [
      {
        ...
        explanation:
          "プロフェッショナルな謝罪と具体的な解決策を提示したビジネスメール",
...

  {
    ...
    promptType: "free-writing",
    instruction:
      "あなたの部署の新しいプロジェクト企画を経営陣に提案する文章を6-8文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "Some companies allow employees to work from home. Do you think this is a good idea? Give reasons and examples to support your opinion. Write 150-200 words.",
...

  {
    ...
    promptType: "guided",
    instruction:
      "You received an email about rescheduling a meeting. Write a response (120-150 words) confirming your availability and suggesting alternative times.",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたが興味を持っている分野の研究について、その目的・方法・結果を5-6文で要約してください。",
...

  {
    ...
    promptType: "free-writing",
    instruction:
      "「オンライン教育は従来の対面教育に完全に取って代わることができるか」について、あなたの立場を明確にし、論理的に論証してください（200-250語）。",
...

  {
    ...
    promptType: "free-writing",
    instruction:
      "「古い写真を見つけた」という設定で、短い物語を5-7文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたが作り出した架空のキャラクターについて、外見・性格・特技を含めて5-6文で描写してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "気候変動対策として個人ができることについて、具体例を含めて5-6文で意見を書いてください。",
...

  {
    ...
    promptType: "free-writing",
    instruction:
      "SNSが人間関係に与える影響について、メリットとデメリットの両面から6-8文で論じてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたが経験した（または経験したい）忘れられない旅行について、5-6文で詳しく書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "日本と他の国の文化的違いについて、具体例を挙げながら5-6文で比較してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたの得意料理のレシピを、作り方の手順を含めて5-6文で説明してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "最近訪れたレストランについて、料理・サービス・雰囲気を含めたレビューを5-6文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "あなたの健康維持のための日常的な取り組みについて4-5文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "最近観た映画について、ストーリー・演技・総合評価を含めて5-6文でレビューを書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "最近聴いた音楽アルバムについて、楽曲・アーティストの表現力・総合評価を含めて5-6文でレビューを書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "人工知能の発展が社会に与える影響について、期待と懸念の両面から6-8文で論じてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "スマートフォンの過度な使用が人々の生活に与える影響と対策について5-6文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "オンライン学習を効果的に進めるためのコツやアドバイスを5-6文で書いてください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "外国語を効果的に習得するための方法について、具体例を含めて6-7文で説明してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "希望する職種の面接で、あなたの強みと志望動機を5-6文で表現してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "上司にリモートワークの導入を提案する文書を、メリットと実施計画を含めて6-8文で作成してください。",
...

  {
    ...
    promptType: "guided",
    instruction:
      "The graph shows quarterly sales data for three products over two years. Describe the trends and make comparisons. Write 150-200 words.",
...

  {
    ...
    promptType: "guided",
    instruction:
      "日常生活で実践できる環境に優しい行動について、具体例を含めて5-6文で書いてください。",
...

  {
    ...
    promptType: "free-writing",
    instruction:
      "「真の幸福とは何か」について、様々な観点から考察し、あなたの結論を7-10文で論述してください。",
