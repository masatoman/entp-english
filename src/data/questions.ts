...
export const questionsByCategory: Record<
  Category,
    ...
    hard: [
      {
        ...
        correctAnswer:
          "The reason why he succeeds is that he never stops making efforts.",
      ...
      },
      {
        ...
        correctAnswer:
          "There are many people in our town who cherish old traditions.",
        explanation:
          '"There are + 名詞 + 関係代名詞" の構文で存在と修飾を同時に表現します。',
      },
      {
        id: 23,
      ...
      },
      {
        ...
        correctAnswer:
          "All the staff who work at this store are kind and treat customers politely.",
        explanation: "関係代名詞と副詞を使って複雑な文を構成しています。",
      },
      {
        id: 25,
        japanese:
          "私が毎朝することは、新聞を読んで世界のニュースを知ることです。",
        correctAnswer:
          "What I do every morning is read the newspaper and learn about world news.",
    ...
    normal: [
      {
        ...
        explanation:
          '継続を表す現在完了進行形を使います。期間は "for" で表現します。',
    ...
    hard: [
      {
        id: 51,
        japanese:
          "彼が到着するまでに、私たちはすべての準備を終えているでしょう。",
        correctAnswer:
          "By the time he arrives, we will have finished all the preparations.",
        explanation:
          '"By the time" は時を表す副詞節で、未来完了と組み合わせます。',
      },
      {
        id: 52,
        japanese:
          "もし昨日雨が降らなかったら、私たちはピクニックに行ったでしょう。",
        correctAnswer:
          "If it had not rained yesterday, we would have gone on a picnic.",
      ...
      },
      {
        ...
        correctAnswer:
          "She had already prepared the materials before the meeting started.",
      ...
      },
      {
        ...
        correctAnswer:
          "When I was a child, I used to visit my grandparents' house every summer.",
      ...
      },
      {
        ...
        correctAnswer:
          "This time next week, we will be working in our new office.",
        explanation:
          "未来進行形で、未来のある時点での進行中の動作を表現します。",
      },
    ],
  },
  modals: {
    ...
    normal: [
      ...
      },
      {
        ...
        explanation:
          '過去にすべきだったことは "should have + 過去分詞" で表現します。',
      ...
      },
      {
        ...
        explanation:
          '義務について質問するときは "Do I have to...?" を使います。',
    ...
    hard: [
      {
        ...
        explanation:
          '"should have + 過去分詞" で過去にすべきだったことを表現します。',
      },
      {
        id: 82,
        japanese:
          "もし彼が真実を話していたなら、問題は起こらなかったでしょう。",
        correctAnswer:
          "If he had told the truth, the problem would not have occurred.",
        explanation:
          '仮定法過去完了では、条件節に "had + 過去分詞"、結果節に "would have + 過去分詞" を使います。',
      },
      {
        id: 83,
      ...
      },
      {
        ...
        explanation:
          '過去の後悔や批判は "should have + 過去分詞" で表現します。',
      },
    ],
  },
  passive: {
    ...
    normal: [
      ...
      },
      {
        ...
        explanation:
          '現在完了の受動態では "has/have been + 過去分詞" を使います。',
    ...
    hard: [
      {
        id: 111,
        japanese:
          "その決定が下される前に、すべての選択肢が検討されていました。",
        correctAnswer:
          "All options had been considered before the decision was made.",
      ...
      },
      {
        ...
        correctAnswer:
          "This technology will be further developed in the future.",
      ...
      },
      {
        ...
        explanation:
          '現在進行形の受動態では "is/are being + 過去分詞" を使います。',
      },
    ],
  },
  relative: {
    ...
    hard: [
      {
        id: 141,
        japanese:
          "彼が言ったことは、私たちが予想していたことと全く異なっていました。",
        correctAnswer:
          "What he said was completely different from what we had expected.",
        explanation:
          '関係代名詞 "what" は「～すること」を表し、先行詞を含みます。',
      },
      {
        id: 142,
        japanese: "彼女は、その会社で働いている間に多くのことを学びました。",
        correctAnswer:
          "She learned a lot while she was working at the company.",
      ...
      },
      {
        ...
        correctAnswer:
          "The person I respect most is someone who always helps others.",
    ...
    normal: [
      {
        ...
        correctAnswer:
          "If it had not rained yesterday, we would have gone on a picnic.",
        explanation:
          '仮定法過去完了では、if節は過去完了、主節は "would have + 過去分詞" を使います。',
      ...
      },
      {
        id: 163,
        japanese:
          "もし私があの時違う道を選んでいたら、今は違う仕事をしていたでしょう。",
        correctAnswer:
          "If I had chosen a different path at that time, I would be doing a different job now.",
      ...
      },
      {
        ...
        correctAnswer:
          "If she had come earlier, she would have been in time for the meeting.",
    ...
    hard: [
      {
        id: 171,
        japanese:
          "もし彼があの時違う決断をしていたら、今頃は全く違う人生を送っていたでしょう。",
        correctAnswer:
          "If he had made a different decision at that time, he would be living a completely different life now.",
        explanation:
          "混合仮定法：過去の仮定の条件と現在の仮定の結果を組み合わせます。",
      },
      {
        id: 172,
        japanese:
          "もし私が彼の立場にいたとしても、同じ決断をしたかもしれません。",
        correctAnswer:
          "Even if I had been in his position, I might have made the same decision.",
        explanation: '"Even if" を使った強調的な仮定法表現です。',
      },
      {
        id: 173,
        japanese:
          "もし技術がもっと発達していたら、この問題はとっくに解決されていたでしょう。",
        correctAnswer:
          "If technology had been more advanced, this problem would have been solved long ago.",
        explanation: "仮定法過去完了と受動態の組み合わせです。",
      },
      {
        id: 174,
        japanese:
          "もし私があの時真実を知っていたら、違う行動を取っていたでしょう。",
        correctAnswer:
          "If I had known the truth at that time, I would have acted differently.",
        explanation: "知識の仮定を表す複雑な仮定法構造です。",
      },
      {
        id: 175,
        japanese:
          "もし彼が今ここにいたら、この状況をどう解決するか教えてくれるでしょう。",
        correctAnswer:
          "If he were here now, he would tell us how to solve this situation.",
    ...
    hard: [
      {
        id: 231,
        japanese:
          "長年の経験を積んだ結果、彼は専門家として認められるようになりました。",
        correctAnswer:
          "Having accumulated years of experience, he came to be recognized as an expert.",
        explanation: "完了分詞構文と受動態の組み合わせです。",
      },
      {
        id: 232,
        japanese:
          "多くの困難に直面しながらも、彼らはプロジェクトを完成させました。",
        correctAnswer:
          "Despite facing many difficulties, they completed the project.",
      ...
      },
      {
        ...
        correctAnswer:
          "Having been loved by many people, the song is still popular today.",
    ...
    hard: [
      {
        ...
        explanation:
          '"be said to have + 過去分詞" で完了の不定詞を使った伝聞表現です。',
      },
      {
        id: 262,
        ...
        explanation:
          '"too + 形容詞 + to + 動詞" で「～するには～すぎる」を表現します。',
      },
      {
        id: 263,
        ...
        explanation:
          '"be supposed to have + 過去分詞" で過去の推測を表現します。',
      },
      {
        id: 264,
