...
export default function FoundationDifficultySelection() {
  ...
  const handleDifficultySelect = (difficulty: string) => {
    ...
    navigate(`/learning/foundation/sets/${actualCategory}/${difficulty}`);
  };
          ...
          <div className="text-sm text-gray-700">
            {actualCategory === "parts-of-speech" && (
              <div className="space-y-2">
                <p>
                  • <strong>名詞</strong>: 人・物・事の名前（student, book,
                  happiness）
                </p>
                <p>
                  • <strong>動詞</strong>: 動作・状態を表す（run, is, have）
                </p>
                <p>
                  • <strong>形容詞</strong>: 名詞を修飾（beautiful, important）
                </p>
                <p>
                  • <strong>副詞</strong>: 動詞・形容詞を修飾（quickly, very）
                </p>
              </div>
            )}
            {actualCategory === "word-order" && (
              <div className="space-y-2">
                <p>
                  • <strong>基本語順</strong>: 主語 + 動詞 + 目的語（SVO）
                </p>
                <p>
                  • <strong>修飾語の位置</strong>:
                  形容詞は名詞の前、副詞は動詞の後
                </p>
                <p>
                  • <strong>疑問詞</strong>: 文頭に置く（What, Where, When）
                </p>
                <p>
                  • <strong>時間・場所</strong>: 通常は文の最後に置く
                </p>
              </div>
            )}
            {actualCategory === "pronouns" && (
              <div className="space-y-2">
                <p>
                  • <strong>人称代名詞</strong>: I/you/he/she/it/we/they
                </p>
                <p>
                  • <strong>所有代名詞</strong>: my/your/his/her/its/our/their
                </p>
                <p>
                  • <strong>目的格</strong>: me/you/him/her/it/us/them
                </p>
                <p>
                  • <strong>疑問代名詞</strong>: who/what/which/whose
                </p>
              </div>
            )}
            {actualCategory === "articles" && (
              <div className="space-y-2">
                <p>
                  • <strong>a/an</strong>: 初めて言及する可算名詞の単数形
                </p>
                <p>
                  • <strong>the</strong>: 特定の物・既知の物・唯一の物
                </p>
                <p>
                  • <strong>無冠詞</strong>: 不可算名詞・複数形の一般的言及
                </p>
                <p>
                  • <strong>固有名詞</strong>: 通常は冠詞不要
                </p>
              </div>
            )}
            {actualCategory === "prepositions" && (
              <div className="space-y-2">
                <p>
                  • <strong>時間</strong>: at(時刻), on(曜日), in(月・年)
                </p>
                <p>
                  • <strong>場所</strong>: at(地点), on(表面), in(内部)
                </p>
                <p>
                  • <strong>方向</strong>: to(到達点), from(起点), toward(方向)
                </p>
                <p>
                  • <strong>手段</strong>: by(交通手段), with(道具・同伴)
                </p>
              </div>
            )}
            {/* 他のカテゴリーも同様に追加可能 */}
