...
export function AppSettings() {
  ...
  const loadSettings = () => {
    ...
    const savedNotificationSettings = notificationManager.getSettings();
  ...
  const permissionStatus = {
    ...
    denied: { text: "拒否", color: "text-red-600" },
    default: { text: "未設定", color: "text-yellow-600" },
  }[permission] || { text: "不明", color: "text-gray-600" };

  const StatusIcon = permission === "granted" ? CheckCircle : Bell;
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSettingChange("grammarQuizQuestionCount", parseInt(value))
              }
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSettingChange("vocabularyQuestionCount", parseInt(value))
              }
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  正解・不正解時の効果音（correct.wav,
                  incorrect.wav）を有効/無効にします
                </p>
              </div>
              <Switch
                  ...
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${
                        bgmVolume * 100
                      }%, #e5e7eb ${bgmVolume * 100}%, #e5e7eb 100%)`,
                    }}
                  />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleNotificationSettingChange("dailyReminder", checked)
                    }
                    disabled={
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="text-xs text-gray-600 space-y-1">
                  <li>
                    • <strong>iPhone</strong>: Safari 推奨
                  </li>
                  <li>
                    • <strong>Android</strong>: Chrome, Edge
                  </li>
                  <li>
                    • <strong>デスクトップ</strong>: Chrome, Edge
                  </li>
                  <li>
                    • <strong>制限</strong>: iOS版サードパーティブラウザ
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-3 rounded-lg">
              <p className="text-xs text-blue-700">
                <strong>💡 iPhoneユーザーの方へ</strong>
                <br />
                Brave、Chrome等では制限があります。Safari
                でアクセスして「共有ボタン →
                ホーム画面に追加」をお試しください。
              </p>
            </div>
