...
export function AppSettings() {
  ...
  const [soundEffectsEnabled, setSoundEffectsEnabled] = useState(SoundManager.getSoundEffectsEnabled());
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="sound-effects-enabled" className="flex items-center gap-2">
                  <Volume2 className="w-4 h-4" />
                  正解・不正解音を有効にする
                </Label>
                <p className="text-sm text-muted-foreground">
                  正解・不正解時の効果音（correct.wav, incorrect.wav）を有効/無効にします
                </p>
              </div>
              <Switch
