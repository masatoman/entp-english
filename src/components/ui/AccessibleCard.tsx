...
export const AccessibleCard = React.forwardRef<HTMLDivElement, AccessibleCardProps>(
  ({
    ...
    const getAriaDescription = () => {
      ...
      if (keyboardShortcut) descriptions.push(`キーボードショートカット: ${keyboardShortcut}`)
      if (clickable) descriptions.push('EnterキーまたはSpaceキーでアクティベート')
...
export const AccessibleCardHeader = React.forwardRef<HTMLDivElement, AccessibleCardHeaderProps>(
...
export const AccessibleCardContent = React.forwardRef<HTMLDivElement, AccessibleCardContentProps>(
