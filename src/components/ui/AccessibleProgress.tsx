    ...
    return (
      ...
      >
        ...
        <div
          ...
          aria-describedby={getAriaDescription() ? 'progress-description' : undefined}
        ...
        >
          <div
            ...
            style={{
              ...
              transform: isIndeterminate ? 'translateX(-100%)' : 'translateX(0)',
              animation: isIndeterminate ? 'indeterminate 2s infinite linear' : undefined
            }}
          />
        </div>
