...
// 学習関連専用ログ
export const logLearning = (message: string, data?: any) =>
  logger.learningProgress(message, data);
export const logGame = (message: string, data?: any) =>
  logger.gameProgress(message, data);
...
// 重要なエラー
export const logCritical = (message: string, error?: Error, data?: any) =>
  logger.criticalError(message, error, data);
